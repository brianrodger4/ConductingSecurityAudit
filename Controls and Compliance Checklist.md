...
To strengthen Botium Toys’ security posture and ensure the protection of sensitive data, a range of security controls should be established. These include enforcing least privilege access, developing formal disaster recovery procedures, implementing strong password management policies, maintaining separation of duties, deploying an intrusion detection system (IDS), managing legacy systems appropriately, and utilizing encryption alongside a centralized password management solution.

To close existing compliance gaps, Botium Toys should also focus on implementing least privilege access, separation of duties, and encryption. Furthermore, a comprehensive asset classification process is required to better identify information assets and determine any additional controls needed to further enhance security and safeguard sensitive information.